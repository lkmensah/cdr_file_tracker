...
export default function PortalFileDetail() {
    ...
    const handleSendInstruction = async () => {
        ...
        const fromLabel = isSG ? `${isActingSG ? 'Acting ' : ''}Solicitor General (${attorney.fullName})` : attorney.fullName;
